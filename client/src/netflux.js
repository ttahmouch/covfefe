...
export default {
    ...
    "$views": {
        ...
        "netflix_originals": (
            <div className="showcase"
                 data-state="netflix_originals"
                 data-state-repeat="true"
                 data-state-repeat-key="show">
                <div className="showcase_movie"
                     data-state="id"
                     data-state-path="$.view.show.id"
                     data-bind-state="key">
                    <form className="showcase_movie_image"
                          data-event="on_click_movie"
                          data-bind-event="onSubmit"
                          data-state-type="dictionary">
                        <input type="hidden"
                               name="id"
                               data-bind-state="defaultValue"
                               data-state="id"
                               data-state-path="$.view.show.id"/>
                        <input type="hidden"
                               name="media_type"
                               data-bind-state="defaultValue"
                               data-state="media_type"
                               data-state-path="$.view.show.media_type"
                               data-state-default-value="tv"/>
                        <input className="showcase_movie_image"
                               type="image"
                               data-bind-state="src"
                               data-state="show_poster_image"
                               alt=""/>
                    </form>
                </div>
            </div>
                ...
                <div className="showcase_movie"
                    ...
                    <form className="showcase_movie_image"
                        ...
                        <input className="showcase_movie_image"
                               type="image"
                               data-bind-state="src"
                               data-state="show_backdrop_image"
                               alt=""/>
                    </form>
                </div>
            </div>
        ...
        "netflix_originals_row": (
            <>
                <h1 className="movieShowcase__heading"
                    data-state="netflix_originals_title">
                    (netflix_originals_title)
                </h1>
        ...
        "header": (
            <header data-style="movie_background_image_style"
                    className="header">
                <div className="header__container">
                    <h1 className="header_title"
                        data-state="movie_title"
                        data-state-path="$.app.$states.movie.title"
                    ...
                    <button className="header__container-btnPlay"
                        ...
                        <div data-view="play_icon"
                             className="header_container_button_play"/>
                        <span data-state="play_title"/>
                    </button>
                    <button className="header__container-btnMyList"
                            data-bind-event="onClick"
                            data-event="on_click_play">
                        <div data-view="add_icon"
                             className="header__container-btnMyList-add"/>
                        <span data-state="my_list_title"/>
                    </button>
                    <p className="header__container-overview"
                       data-state="movie_overview"
                       data-state-path="$.app.$states.movie.overview"
                       data-state-default-value="Movie Overview"/>
                </div>
        ...
        "modal": (
            <>
                <div className="backdrop"
                     data-bind-event="onClick"
                     data-event="on_click_modal_background"/>
                <div className="modal show"
                     data-style="movie_background_image_style">
                    <div className="modal__container">
                        ...
                        <p className="modal__info">
                            <span className="modal__rating"
                                  data-state="movie_rating"
                                  data-state-path="$.app.$states.movie.rating"
                                  data-state-default-value="0">
                                Rating: (movie_rating)&nbsp;
                            </span>
                            <span data-state="movie_release"
                                  data-state-path="$.app.$states.movie.release"
                                  data-state-default-value="">
                                Release: (movie_release)&nbsp;
                            </span>
                            <span data-state="movie_runtime"
                                  data-state-path="$.app.$states.movie.runtime"
                                  data-state-default-value="0">
        ...
        "no_results": (
            <div className="no-results">
                <div className="no-results__text">
                    <p data-state="title"
                       data-state-path="$.app.$states.title"
                       data-state-default-value="">
        ...
        "search": (
            <>
                <div data-view="results"
                     data-unless="search_no_results"/>
                <div data-view="no_results"
                     data-if="search_no_results"/>
                <div data-view="modal"
                     data-if="should_show_modal"/>
            </>
        ),
            ...
            <div className="navigation__container--userLogo">
                <div className="dropdownContent">
                    <div>
                        ...
                        <p className="dropdownContent--user-text"
                           data-state="user_one"/>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p className="dropdownContent--user-text"
                           data-state="user_three"/>
                    </div>
                    <p className="dropdownContent-text"
                       data-state="manage_profiles_title"/>
                </div>
                <div className="dropdownContent dropdownContent--2">
                    <p className="dropdownContent-textOutside"
                       data-state="account_title"/>
                    <p className="dropdownContent-textOutside"
                       data-state="help_title"/>
                    <p className="dropdownContent-textOutside"
                       data-state="sign_out_title"/>
                </div>
            </div>
        ),
        "navigation_bar": (
            ...
            <nav className="navigation"
                ...
                <ul className="navigation__container">
                    <img className="navigation__container--logo"
                         ...
                         data-bind-state="src"
                         data-bind-event="onClick"
                         data-event="on_logo_click"
                         alt=""/>
                    <div className="navigation__container--downArrow-2"
                         data-view="down_icon"/>
                    <HomeButton/>
                    <div className="navigation_bar_link pseudo-link"
                         data-state="shows_title"/>
                    <div className="navigation_bar_link pseudo-link"
                         data-state="movies_title"/>
                    <div className="navigation_bar_link pseudo-link"
                         data-state="recently_added_title"/>
                    <div className="navigation_bar_link pseudo-link"
                         data-state="my_list_title"/>
                    <div className="navigation__container--left">
                        <div data-view="search_icon"
                             className="logo"/>
                    ...
                    <div className="navigation_bar_link pseudo-link"
                         data-state="kids_title"/>
                    <div className="navigation_bar_link pseudo-link"
                         data-state="dvd_title"/>
                    <div data-view="bell_icon"
                         className="navigation__container--bellLogo"/>
                    <div data-view="dropdown"/>
                    <div data-view="down_icon"
                         className="navigation__container--downArrow"/>
                </ul>
            </nav>
        ),
        ...$views
    ...
    "$view": (
        <div data-bind-event="DOMContentLoaded"
            ...
            <div data-if-path="/"
                 data-view="home"/>
            <div data-if-path="/search"
                 data-view="search"/>
            <div data-unless-path="^/(?:search)?$"
                 data-view="404"
