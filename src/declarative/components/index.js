...
export const Header = (props) => (
    <nav data-style='navigation_bar'>
        ...
        <Link to='/'>
            <div data-style='navigation_bar_back_button'>◼︎</div>
        </Link>
        <div data-style='navigation_bar_title' data-state='page_title'/>
    </nav>
);
...
export const IndexContent = (props) => (
    <main data-style='main_content'>
        <div data-style='card'>
            <header data-style='card_header' data-state='card_title'/>
...
export const BackContent = (props) => (
    <main data-style='main_content'>
        <div data-style='card'>
            <header data-style='card_header' data-state='card_title_2'/>
            <div data-style='card_main_content'/>
        </div>
    </main>
);
...
export const Footer = (props) => (
    <div>
        <Json data-state='titles_array' data-state-prop='json'/>
        <form data-action-prop='onSubmit' data-action='async_read'
              data-state='titles_array' data-state-type='dictionary'>
            <div>
                <label>Title:</label>
                <input name='title'/>
            </div>
